...
document.getElementById("emailinput").value=opener.document.memberRegisterForm.email.value;
}
</script>
<body>
<div id="wrapper">
...
function sendEmailValue(){
	opener.document.memberRegisterForm.emailDuplication.value="emailCheck";

	opener.document.memberRegisterForm.email.value=document.getElementById("emailinput").value;
